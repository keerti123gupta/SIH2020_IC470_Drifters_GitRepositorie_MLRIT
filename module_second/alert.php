...
<!--sidebar-menu-->
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-bell"></i> Alert</a>
  <ul>
    ...
    <li class="active"> <a href="alert.php"><i class="icon icon-bell"></i> <span>Alert System</span></a> </li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon icon-dashboard"></i> Dashborad</a> <a href="#" class="current">Alert System</a></div>
    <h1>ALert Panel</h1>
  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-bell"></i> </span>
            <h5>Alert Machenism</h5>
          </div>
          <div class="widget-content">
            <form method="POST" action="alert_send.php" class="form-horizontal">
              <label>Sending ALert Manually when detail available we get automatic</label>
                  ...
                  <button type="submit" name="SubmitButton"class="btn btn-success" id="btnSend">Send</button>
