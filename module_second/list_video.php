...
<!--sidebar-menu-->
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-list"></i> List Videos</a>
  <ul>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon icon-dashboard"></i> Dashboard</a> <a href="#" class="current">Video Stream</a> <a href="#" class="current">List Video</a></div>
    <h1>Video Cloud Panel</h1>
  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content">
            ...
            <div class="row-fluid">
              <div class="span4">
                 <video width="295" height="240" controls>
                    <source src="upload/Animal.mp4" type="video/mp4">
